package com.chau.phimplus.ui.movie_detail.ui.main;
...
import com.chau.phimplus.ui.movie_detail.FragmentLichChieu;
...
public class SectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
       ...
       // return PlaceholderFragment.newInstance(position + 1);
        ...
        switch (position){
            case 0:
                fragment = new FragmentThongTin();
                break;
            case 1:
                fragment = new FragmentLichChieu();
                break;
            case 2:
